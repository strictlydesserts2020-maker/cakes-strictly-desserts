      ...
      <div className={viewClass("home")}>
        ...
        <style>{`
          @media (max-width: 767px) {
            .cust-cta-banner { padding-right: 1.5rem !important; min-height: unset !important; }
            .cust-cta-banner .cust-cta-img { position: static !important; transform: none !important; display: block; margin: 1.5rem auto 0; height: 180px !important; width: auto !important; }
          }
        `}</style>
        <section className="block" style={{ paddingTop: 0, paddingBottom: 0 }}>
          <div className="container">
            <div className="hamper-banner cust-cta-banner" style={{ background: "linear-gradient(135deg, #d4456b 0%, #8B1A4A 100%)", color: "#fff", paddingRight: "260px" }}>
              ...
              <img src="/customise-banner.jpg" alt="Custom Cake" className="cust-cta-img" style={{ position: "absolute", right: "2.5rem", top: "50%", transform: "translateY(-50%)", height: "210px", width: "auto", borderRadius: "14px", objectFit: "cover", boxShadow: "0 8px 32px rgba(0,0,0,0.25)" }} />
            </div>
          </div>
        </section>
      ...
      <section className="dp-footer-cta">
        <div className="container">
          ...
          <div className="dp-footer-cta-btns">
            ...
            <a className="btn btn-ghost btn-lg" href="tel:+919003082979">📞 Call us at +91 90030 82979</a>
          </div>
        </div>
      </section>
